...
| `role` | 회원 권한 | `VARCHAR(20)` | N | - | - | `USER`, `ADMIN` |
...
| `status` | 숙소 상태 | `VARCHAR(20)` | N | - | - | `ACTIVE`, `INACTIVE` |
...
| `status` | 객실 상태 | `VARCHAR(20)` | N | - | - | `ACTIVE`, `INACTIVE` |
